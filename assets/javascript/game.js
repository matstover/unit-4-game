...
console.log(greenGemNumber)
    ...
    (goalScore) === Math.floor((Math.random() * 19) + 1) <= (goalScore) === Math.floor((Math.random() * 19 + 120))
console.log(goalScore)
// Upon crystal clickup add that number to the score
function blueGemNumber() {
    var onmouseup (Math.floor((Math.random() * 12) + 1);
}
console.log(blueGemNumber)

$("blueGemNumber").on("click", function ();
$("greenGemNumber").on("click", function ();
$("pinkGemNumber").on("click", function ();
$("yellowGemNumber").on("click", function ();
